...
-- ESPN really does store 'Beer League ' with a trailing space (MLB-227).
--
...
-- label next to a hand-typed 'Beer League', or as two groups where a reader
-- expects one. stg_divisions trims at the staging boundary; this asserts the
-- trim is actually still there.
--
